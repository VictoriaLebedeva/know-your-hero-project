...
def set_auth_cookies_and_refresh_token(response, user, session, old_refresh_token_db=None):
    ...
    refresh_token, jti, expiration_date = generate_jwt(user.id, user.role, timedelta(days=30))
